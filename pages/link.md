...
- 本列表会持续更新、尽量分类、补充信息、交换友链在评论区留言即可
...
- >自己收藏的个人独立博客 [https://blog.502.li/link](https://blog.502.li/link)
	...
	>
	>其次，拥有独立博客、能自己建站、有自己的域名、会生成静态博客等等这些能力就已经帮你过滤掉那些还在用百度的菜鸡了；
	>
	>最后独立博客内容大多都是个人原创
	>
	>引用自本人推文

- 另外推荐  [tuna]( https://tuna.moe/ )  收集的博客列表  [tuna/blogroll]( https://github.com/tuna/blogroll )
...
| [Laisky]([https://blog.laisky.com](https://blog.laisky.com/) | Docker、后端、Python、读书笔记                        | 一只高语速大存储的复读鸭，疯起来会自己复读自己。 |
