...
![1561802376515](/img/1561802376515.png)
...
![1561820474017](img/1561820474017.png)

选择代码操作为运行外壳

![1561820507625](img/1561820507625.png)

添加 shell 运行命令，所有的操作都要使用 root 运行

![1561820547351](img/1561820547351.png)

添加完成后，点击左下角那个开始按钮，如果任务左边为绿点，则运行成功。如果为红点，则会出现报错信息。

![1561820617830](img/1561820617830.png)
